...
const BikeCard = ({ bike }) => {
    const {_id, photo, title, location, price, fuelType, seats, speed } = bike;
            ...
            <div className="relative border rounded-xl">
                ...
                <div className="p-5">
                    ...
                    <div className="flex items-center justify-between pt-2">
                        ...
                        <Link to={`/bikeDetails/${_id}`} className=" bg-[#f2f2ff] px-4 py-2 rounded-full text-sm font-semibold hover:bg-[#e5e5fc]">Book Now</Link>
                    </div>
                </div>
