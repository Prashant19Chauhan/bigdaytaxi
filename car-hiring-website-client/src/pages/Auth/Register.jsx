        ...
        <div className="flex items-center justify-center w-full h-screen px-3">
            <form onSubmit={handleRegister} className="w-[400px] border px-6 py-12 space-y-5 shadow-[0px_0px_10px_0px] shadow-gray-300 rounded-xl bg-gray-100">
                ...
                <div>
                    ...
                    <input type="name" name="name" placeholder="Your Name" required className="border p-2 text-[15px] font-semibold text-gray-600 w-full outline-purple-400 bg-gray-200 rounded-lg" />

                </div>
                <div>
                    <p className="text-sm pb-1">Your photo : </p>
                    <input type="file" name="photo" required className="border p-2 text-[15px] font-semibold text-gray-600 w-full outline-purple-400 bg-gray-200 rounded-lg" />
                </div>
                <div>
